...
const OrderFilter = () => {
    ...
    return (
        <div className={style.conteiner}>
            ...
            <label htmlFor="allPokemons" className={style.label}> All Pokemons
                <input type="radio" name="filter" id="allPokemons" value="All Pokemons" onChange={handleFilter} />
            </label>
            <label htmlFor="api" className={style.label}> Api
                <input type="radio" name="filter" id="api" value="Api" onChange={handleFilter} />
            </label>
            <label htmlFor="baseDeDatos" className={style.label}> Base de Datos
                <input type="radio" name="filter" id="baseDeDatos" value="Base de Datos" onChange={handleFilter} />
            </label>
            </div>
        </div>
  );
